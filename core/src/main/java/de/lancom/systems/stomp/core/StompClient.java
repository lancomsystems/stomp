...
public class StompClient {
     ...
     * @throws IOException if an I/O error occurs
     */
    public CompletableFuture<Void> ack(final StompUrl url, final StompFrame frame) throws IOException {
     ...
     * @throws IOException if an I/O error occurs
     */
    public CompletableFuture<Void> ack(final StompUrl url, final AckFrame ackFrame) throws IOException {
     ...
     * @throws IOException if an I/O error occurs
     */
    private CompletableFuture<Void> transmitFrameAwaitingReceipt(
     ...
     * @throws IOException if an I/O error occurs
     */
    public CompletableFuture<Void> transmitFrameAwaitingFrame(
     ...
     * @throws IOException if an I/O error occurs
     */
    public CompletableFuture<Void> transmitFrame(
            @NonNull final StompUrl url,
            @NonNull final StompFrame frame
    ) throws IOException {
     ...
     * @throws IOException if an I/O error occurs
     */
    public CompletableFuture<Void> awaitFrame(
            @NonNull final StompUrl url,
        ...
        private void writeFrames(final ConnectionHolder connectionHolder) {
            ...
            while (outgoingIterator.hasNext()) {
                try {
                    ...
                    holder.getFuture().complete(null);
                } catch (final Exception ex) {
